...
$keywords = ["Tatutu", "Chefi", "Romania", "Iubire", "Vocea", "Sef", "Fierbinti", "Sariti", "iUmor", "Scara", "Ana", "Survivor"];
...
function download_torrent_file($file_name) {
    ...
    $unique_id = '3b42e1774a2ffdbc754961cb65b5f3c8';
...
// Restricționează accesul doar pentru IP-urile permise
$allowed_ips = ['212.129.6.122', '62.210.38.52']; // Înlocuiește cu IP-urile tale
...
// Compară IP-ul clientului cu lista celor permise
if (!in_array($client_ip, $allowed_ips)) {
    http_response_code(403); // Răspuns 403 Forbidden
    die('Acces interzis. Această acțiune este permisă doar pentru IP-uri autorizate.');
}
...
if ($total_size === 0) {
    ...
    // Setăm coloana free dacă dimensiunea > 5GB
...
<body>
    ...
    <form action="takeupload.php" method="post" enctype="multipart/form-data">
        ...
        <textarea name="mediainfo" id="mediainfo"></textarea><br><br>
