...
class RssController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return response()->view('rss.create', [
    ...
    public function update(Request $request, $id)
    {
        ...
        $params = $request->only(['search', 'description', 'uploader', 'categories',
            'types', 'genres', 'free', 'double', ]);
        ...
        if (! $success) {
            ...
            if ($v->errors()) {
                ...
                return response()->view('rss.edit', ['id' => $id])
                ->withErrors($error);
        }
