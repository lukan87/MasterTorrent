...
class CleanupHistory extends Command
{
     ...
     * @var string
     */
    protected $description = 'Cleanup duplicate history records where completed_at is null for the same user and torrent';
    ...
    {
        // Get all the records where completed_at is null
        ...
        foreach ($historyRecords as $record) {
            ...
            if ($duplicates->isNotEmpty()) {
                foreach ($duplicates as $duplicate) {
                    ...
                    // Output user_id and torrent_id for each deleted record
                    $this->info("Deleted duplicate record for User ID: {$duplicate->user_id}, Torrent ID: {$duplicate->torrent_id}");
                }
            }
        }
