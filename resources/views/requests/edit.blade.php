        ...
        <div class="request-hero mb-4">
            ...
            <div>
                ...
                <div class="request-subtitle">
                    ...
                    Update your request information and links.
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="url"
                                   ...
                                   id="imdb_url"
                                   class="form-control modern-input"
                                   value="{{ old('imdb_url', $request->imdb_url) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="url"
                                   ...
                                   id="tmdb_url"
                                   class="form-control modern-input"
                                   value="{{ old('tmdb_url', $request->tmdb_url) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="url"
                                   ...
                                   id="steam_url"
                                   class="form-control modern-input"
                                   value="{{ old('steam_url', $request->steam_url) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Add extra details about the request...">{{ old('description', $request->description) }}</textarea>
