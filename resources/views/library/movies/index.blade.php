...
<div class="container-fluid py-4 px-3 px-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <h4 class="fw-bold text-white mb-0">🎬 Movie Library</h4>

        <form method="GET" action="{{ route('library.movies.index') }}" class="search-bar">
            <input 
                type="text" 
                name="q" 
                value="{{ $query ?? '' }}"
    ...
    <div class="row gx-3 gy-4">
        ...
        @forelse($movies as $movie)
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                ...
                <a href="{{ route('library.movies.show', [
                    'tmdbid' => $movie->tmdbid,
                    'slug' => $movie->slug
