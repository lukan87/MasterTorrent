...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="fw-bold text-white"><i class="bi bi-send-fill me-2"></i>Outbox</h1>
            ...
            <table class="table align-middle text-white table-gmail">
                <thead class="table-head">
                    <tr>
                        ...
                        <th scope="col"><i class="bi bi-person-check-fill me-1"></i>Receiver</th>
                        <th scope="col"><i class="bi bi-clock me-1"></i>Sent</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($messages as $index => $message)
                        <tr>
                            ...
                            <td><i class="bi bi-person-check-fill me-1"></i>{{ $message->receiver->name }}</td>
