...
<div class="movie-header-container">
    <div class="movie-header-card mt-3">
        <div class="movie-header-content">
            <div class="row">
                <!-- Poster Column -->
                <div class="col-12 col-sm-4 col-md-3 col-lg-2 poster-column">
                    <div class="poster-wrapper">
                        <img src="{{$torrent->poster}}" lazy="loading" class="movie-poster" alt="{{$tmdbData['title'] ?? 'Movie Poster'}}">
...
<div class="cast-row">
    ...
    @foreach (($tmdbData['credits']['cast'] ?? []) as $castMember)
        ...
        @php
            ...
            $castPlayed = Str::limit($castPlayed, 25); // Limit to 25 chars
            $castImage = isset($castMember['profile_path']) 
                ? "<img class='actor-image' lazy='loading' src='https://www.themoviedb.org/t/p/w300_and_h450_bestv2{$castMember['profile_path']}'>"
